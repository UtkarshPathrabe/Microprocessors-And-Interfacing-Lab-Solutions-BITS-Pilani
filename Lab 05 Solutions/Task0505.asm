...
RectLen7	equ	11		;Length of Rectangle
RectWid7	equ	21		;Width of Rectangle
IniX7		equ	67		;Initial X Co-ordinate
IniY7		equ	114		;Initial Y Co-ordinate
...
ColumnDisp	db	00
PageNumDis	db	00
PixelColor1	db	0Fh		;Fill a Pixel
PixelColor2	db	0Dh
PixelColor3	db	0Ch
PixelColor4	db	0Eh
PixelColor5	db	0Ah
...
mov	ah,	00h			;Set Display Mode
	mov	al,	DesVidMode1
	int	10h
	mov PixelRow,	IniY1		;To create a white block
...
x2:	mov	ah,	0Ch			;Fill a Pixel(Set Pixel)
	...
	dec	CounterRow
	jnz	x1
	mov PixelRow,	IniY2		;To create a magenta block
...
x6:	mov	ah,	0Ch			;Fill a Pixel(Set Pixel)
	...
	dec	CounterRow
	jnz	x5
	mov PixelRow,	IniY4		;To create a yellow block
...
x8:	mov	ah,	0Ch			;Fill a Pixel(Set Pixel)
	...
	dec	CounterRow
	jnz	x7
	mov PixelRow,	IniY5		;To create a green block
...
x12:	mov	ah,	0Ch			;Fill a Pixel(Set Pixel)
	...
	dec	CounterRow
	jnz	x11
	mov PixelRow,	IniY7		;To create a cyan block
